      ...
      <div className="mx-auto max-w-7xl h-16 px-4 sm:px-6 flex items-center justify-end">
        ...
        >
          ...
          <div className="hidden sm:flex items-center gap-6">
            <a href="/" className="hover:underline underline-offset-4 decoration-[#C6A36C]">Home</a>
            <a href="/#about" className="hover:underline underline-offset-4 decoration-[#C6A36C]">About</a>
            <a href="/#contact" className="hover:underline underline-offset-4 decoration-[#C6A36C]">Contact</a>
          </div>
